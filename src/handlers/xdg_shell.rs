...
impl XdgShellHandler for TontooCompositor {
    ...
    fn new_toplevel(&mut self, surface: ToplevelSurface) {
        ...
        // Send configure with a default size so the client knows what to render
        let width = 800;
        let height = 500;
...
fn check_grab(
    seat: &Seat<TontooCompositor>,
    surface: &WlSurface,
    serial: Serial,
) -> Option<PointerGrabStartData<TontooCompositor>> {
