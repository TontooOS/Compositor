...
impl PointerGrab<TontooCompositor> for ResizeSurfaceGrab {
    fn motion(
        &mut self,
        data: &mut TontooCompositor,
        handle: &mut PointerInnerHandle<'_, TontooCompositor>,
    ...
    fn start_data(&self) -> &PointerGrabStartData<TontooCompositor> {
        &self.start_data
    }

    fn unset(&mut self, _data: &mut TontooCompositor) {}
}
